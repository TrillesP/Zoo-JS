...
describe('4 - Crie a gestão das pessoas colaboradoras de acordo com o respectivo gerente', () => {
  it('retorna true se o id é gerente', () => {
    const expected = true;
  ...
  it('retorna false se o id não é gerente', () => {
  ...
  it('retorna uma array com o nome das pessoas colaboradoras do respectivo gerente', () => {
    const actual = getRelatedEmployees(stephanieId);
    const expected = [ 'Burl Bethea', 'Ola Orloff', 'Emery Elser' ];
    expect(actual).toEqual(expected);
  });

  it('dispara erro "O id inserido não é de uma pessoa colaboradora gerente!" quando id não for genrente', () => {
