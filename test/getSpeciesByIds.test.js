...
describe('getSpeciesByIds', () => {
  it('nenhum parâmetro retorna um array vazio', () => {
    const actual = getSpeciesByIds();
    const expected = [];
    expect(actual).toEqual(expected);
  });

  it('id retorna array com espécie referente a esse id', () => {
    {
  ...
  it('mais de um id retorna um array com as espécies dos ids', () => {
    const actual = getSpeciesByIds(
